...
<h2 class="mb-2 mt-6 text-sm font-medium uppercase tracking-wide text-mlq-muted">What is a knowledge base?</h2>
...
<p class="mb-3 max-w-prose text-sm leading-relaxed text-mlq-text">
  Open a KB and click <strong>Rename</strong> in the header. A dialog lets you update both the <strong>Name</strong> and an optional <strong>Description</strong>. Click <strong>Save</strong> to apply the changes. Press <strong>Cancel</strong> or hit Escape to close without saving.
</p>

<h2 class="mb-2 mt-6 text-sm font-medium uppercase tracking-wide text-mlq-muted">Uploading documents</h2>
<p class="mb-3 max-w-prose text-sm leading-relaxed text-mlq-text">
  Inside a KB, the <strong>Files</strong> section shows all attached documents. If the KB is empty you will see a drop zone — drag files onto it or click to open a file picker. Once files are present, use the <strong>+ Add file</strong> button to upload more.
</p>
<p class="mb-3 max-w-prose text-sm leading-relaxed text-mlq-text">
  After upload, each file moves through ingestion states: <strong>Pending</strong> → <strong>Processing</strong> → <strong>Ready</strong>. Donna polls automatically and attaches the file once it is ready. If a file is still processing after several minutes, a <strong>Refresh</strong> prompt appears. Files that cannot be ingested show a <strong>Failed</strong> status with an error message.
</p>
<p class="mb-3 max-w-prose text-sm leading-relaxed text-mlq-text">
  <strong>Recommended format: PDF.</strong> PDF files ingest reliably. Some other file types — including plain <code>.txt</code> files — may be rejected with an "unsupported type" error. If a file fails to ingest, try converting it to PDF before uploading.
</p>
<p class="mb-3 max-w-prose text-sm leading-relaxed text-mlq-text">
...
<p class="mb-3 max-w-prose text-sm leading-relaxed text-mlq-text">
  Answers that draw from a knowledge base cite their sources so you can verify exactly which document and passage the answer came from. See the <strong>Trust &amp; citations</strong> page for a full explanation of how citations work in Donna.
</p>

<h2 class="mb-2 mt-6 text-sm font-medium uppercase tracking-wide text-mlq-muted">Archiving a knowledge base</h2>
<p class="mb-3 max-w-prose text-sm leading-relaxed text-mlq-text">
  When a knowledge base is no longer needed, open it and click <strong>Archive</strong> in the header. Archived KBs are removed from the active list and will not be searched. This is useful for keeping the Knowledge view tidy without permanently deleting documents.
</p>
