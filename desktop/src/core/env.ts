...
export function renderEnv(cfg: LauncherConfig): string {
	...
	return [
		...
		'# Gateway master key (Fernet) — encrypts runtime provider/research keys at rest.',
		'# Without it, setting a CourtListener/GovInfo key in Settings → Research sources fails.',
