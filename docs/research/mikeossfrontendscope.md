...
The MikeOSS _look_ is framework-agnostic. The _framework_ is not load-bearing for the visual goal.
...
_Maintained by the maintainer team on `claude/mikeoss-frontend-scope-uILRz` until the branch lands or is retired._
