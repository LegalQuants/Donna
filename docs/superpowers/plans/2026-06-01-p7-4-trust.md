...
<p class="mb-6 text-sm leading-relaxed text-mlq-muted">
	...
	<strong class="text-mlq-text">Cloud</strong> models are routed through the anonymization layer before
	any request leaves. Each model carries a tier; privileged matters enforce a minimum tier.
</p>
