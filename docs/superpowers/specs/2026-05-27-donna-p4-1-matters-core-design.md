...
Give Donna a first-class **Matters** surface (the backend calls them *projects*; the UI calls them
*matters*) and let a chat be **scoped to a matter**. Scoping is the keystone: a chat with a
