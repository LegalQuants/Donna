...
Parent design: `docs/superpowers/specs/2026-05-26-donna-p3-document-panel-design.md` (decisions §2 still hold). This spec resolves the *how* for the items that doc deferred to P3-2.
...
- **Click / Enter / Space** now *only* calls `onactivate(citation)` (rename of P3-1's `onopen`) → opens the panel. It no longer toggles the popover.
